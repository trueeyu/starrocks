...
public:
    ...
    static TabletSchemaSPtr create(const TabletSchema& tablet_schema, const std::vector<int32_t>& column_indexes);
    static TabletSchemaSPtr create(const TabletSchema& tablet_schema);
