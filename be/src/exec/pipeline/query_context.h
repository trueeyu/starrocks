...
public:
    ...
    int num_active_fragments() const { return static_cast<int>(_num_active_fragments.load()); }
    ...
    inline int get_query_expire_seconds() const { return static_cast<int>(_query_expire_seconds.count()); }
