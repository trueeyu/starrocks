...
public:
    ...
    static Status prepare(RuntimeState* runtime, JoinHashTableItems* table_items);
...
public:
    ...
    static Status prepare(RuntimeState* state, JoinHashTableItems* table_items);
...
public:
    ...
    Status probe_prepare(RuntimeState* state);
