...
struct AggHashMapVariant {
    enum class Type {
        ...
        phase1_timestamp = 10,
        phase1_string = 11,
        phase1_null_uint8 = 12,
        phase1_null_int8 = 13,
        phase1_null_int16 = 14,
        phase1_null_int32 = 15,
        phase1_null_int64 = 16,
        phase1_null_int128 = 17,
        phase1_null_decimal32 = 18,
        phase1_null_decimal64 = 19,
        phase1_null_decimal128 = 20,
        phase1_null_date = 21,
        phase1_null_timestamp = 22,
        phase1_null_string = 23,
        phase1_slice = 24,
        phase1_slice_two_level = 25,
        phase1_int32_two_level = 26,
        phase1_null_string_two_level = 27,
        phase1_string_two_level = 28,

        phase1_slice_fx4 = 29,
        phase1_slice_fx8 = 30,
        phase1_slice_fx16 = 31,
        ...
        phase2_decimal32 = 38,
        phase2_decimal64 = 39,
        phase2_decimal128 = 40,
        phase2_date = 41,
        phase2_timestamp = 42,
        phase2_string = 43,
        phase2_null_uint8 = 44,
        phase2_null_int8 = 45,
        phase2_null_int16 = 46,
        phase2_null_int32 = 47,
        phase2_null_int64 = 48,
        phase2_null_int128 = 49,
        phase2_null_decimal32 = 50,
        phase2_null_decimal64 = 51,
        phase2_null_decimal128 = 52,
        phase2_null_date = 53,
        phase2_null_timestamp = 54,
        phase2_null_string = 55,
        phase2_slice = 56,
        phase2_slice_two_level = 57,
        phase2_int32_two_level = 58,
        phase2_null_string_two_level = 59,
        phase2_string_two_level = 60,

        phase2_slice_fx4 = 61,
        phase2_slice_fx8 = 62,
        phase2_slice_fx16 = 63,
